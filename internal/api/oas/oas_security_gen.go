...
var operationRolesBearerAuth = map[string][]string{
	AcknowledgeAlertOperation:        []string{},
	CancelExecutionOperation:         []string{},
	CreateAlertOperation:             []string{},
	CreateWorkflowOperation:          []string{},
	DeleteWorkflowOperation:          []string{},
	ExecuteWorkflowOperation:         []string{},
	GetAlertOperation:                []string{},
	GetExecutionOperation:            []string{},
	GetWorkflowOperation:             []string{},
	ListAlertsOperation:              []string{},
	ListAuditLogsOperation:           []string{},
	ListAuditLogsByResourceOperation: []string{},
	ListAuditLogsByUserOperation:     []string{},
	ListExecutionsOperation:          []string{},
	ListWorkflowExecutionsOperation:  []string{},
	ListWorkflowsOperation:           []string{},
	ResolveAlertOperation:            []string{},
